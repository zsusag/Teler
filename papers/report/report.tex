...
\begin{multicols}{2}
  ...
  ***Evaluation summary.***
  ...
  % talk about how teler is a snapshot driven VCS and thus relies upon
  ...
  % talk about how directory tree traversal is used nicely.. anything
  % more? idk... I can't remember
